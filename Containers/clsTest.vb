Public Class clsTest
    ...
    Public Function GetTestInfo(ByVal TestID As Long) As TestStructure
        ...
        strSQL = strSQL & "FROM "
        strSQL = strSQL & "tblTestSetDetail join "
        strSQL = strSQL & "tblItemTest on (tblTestSetDetail.TestSetID = tblItemTest.TestSetID) and (tblTestSetDetail.InspectionNo = tblItemTest.InspectionNo)"
        strSQL = strSQL & "WHERE "
